...
function Soap:GetRandomRegularSoap()
...
function Soap:GetSoapInCampChest(shallow)
...
function Soap:GetSoapInCharacterInventory(character, shallow)
...
---@param shallow boolean If true, recursively checks inside bags and containers.
---@return table - table of soap items in the character's inventory, or nil if none found.
function Soap:GetSoapInInventory(inventory)
    local matchedItems = {}
...
function Soap:PartyHasEnoughSoap()
...
function Soap:DeliverSoapToParty()
...
function Soap:HygienizePartyMembers()
